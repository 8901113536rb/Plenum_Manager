...
import '../VendorController/VendoOtpverificationController.dart';
import '../constants/Appsizes.dart';
import '../constants/Stringconstants.dart';
import '../constants/Textstyles.dart';
import '../utils/CommonbtnWidget.dart';
import 'Vendordashboardui.dart';

class Vendorotpverification extends StatefulWidget {
   Vendorotpverification({Key? key}) : super(key: key);

  @override
  State<Vendorotpverification> createState() => _OtpverificationState();
}

class _OtpverificationState extends State<Vendorotpverification> {
  // final pinController = TextEditingController();
  final focusNode = FocusNode();
  final formKey = GlobalKey<FormState>();
  VendorOtpverificationController controller=Get.put(VendorOtpverificationController());
  @override
